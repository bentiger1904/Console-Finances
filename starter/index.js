...
//Net Profit Over Period
for (var i = 0; i < finances.length; i++) {
  month = finances[i][0];
  dollarAmount = finances[i][1];
  sum += dollarAmount;

  if (i > 0) change = dollarAmount - previousAmount;
  previousAmount = dollarAmount;
  netChange += change;
//Greatest Increase in Profits/Losses
  if (change > increase[1]) {
    increase = [month, change];
  }
//Greatest Decrease in Profits/Losses
  if (change < decrease[1]) {
    decrease = [month, change];
  }
}
